...
const events = (() => {
  ...
  body.addEventListener("click", (e) => {
    if (
      e.target.classList.contains("empty-card") ||
      e.target.classList.contains("empty-card-icon")
    ) {
      ...
      e.target.classList.contains("checkbox-span")
    ) {
      const tagIndex =
        e.target.parentNode.parentNode.parentNode.getAttribute("data-tag-id");
      const taskIndex =
        e.target.parentNode.parentNode.parentNode.getAttribute("data-task-id");
      tasks.markDone(
